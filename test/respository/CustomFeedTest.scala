...
class CustomFeedTest extends FeatureSpec with GivenWhenThen {
  ...
  feature(" Add Records to the Respository"){
    ...
    scenario("Create Tables in The Database "){
      ...
      val feed1 = CustomFeed("ZM","1","PT","http://postzambia.com/search.php?cmd=category&catid=67","www.postzambia.com","image")
      ...
      val feed4 = CustomFeed("ZM","4","QF","http://qfmzambia.com/newsroom.php?idx=1","www.qfmzambia.com","image")
